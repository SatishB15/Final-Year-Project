<?php
	...
	{	
		...
		if((mysqli_num_rows($result))!=1) 
		{
			echo "<center>
			<h3>
			<script>alert('Sorry.. Wrong Username (or) Password');
			</script>
			</h3>
			</center>";
							...
							<form method="post" action="login.php" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label class="fw">Enter Your Password:
										<a href="forget.php" class="pull-right">Forgot Password?</a>
									</label>
									<input type="password" name="password" class="form-control">
								</div> 
								<div class="form-group text-right">
									<button class="btn btn-primary btn-block purple-gradient" name="submit">Login</button>
								</div>
